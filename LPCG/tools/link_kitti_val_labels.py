...
if __name__ == '__main__':
    ...
    dst_label_dir_3 = ['{}/{}/filter_label_2_all_categories'.format(kitti_root_dir, i) for i in mode]

    all_val_labels = sorted(os.listdir(val_label_dir))
    for dst, dst2, dst3 in zip(dst_label_dir, dst_label_dir_2, dst_label_dir_3):
        for f in tqdm(all_val_labels):
            ...
            os.symlink(os.path.join(val_label_dir, f), os.path.join(dst3, f))
